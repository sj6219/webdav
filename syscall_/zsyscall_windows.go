...
import (
	"syscall"
	"github.com/hacdias/webdav/v3/internal_/syscall_/windows_/sysdll_"
	"unsafe"
)
...
var (
	modkernel32 = syscall.NewLazyDLL(sysdll_.Add("kernel32.dll"))
	modadvapi32 = syscall.NewLazyDLL(sysdll_.Add("advapi32.dll"))
	modshell32  = syscall.NewLazyDLL(sysdll_.Add("shell32.dll"))
	modmswsock  = syscall.NewLazyDLL(sysdll_.Add("mswsock.dll"))
	modcrypt32  = syscall.NewLazyDLL(sysdll_.Add("crypt32.dll"))
	modws2_32   = syscall.NewLazyDLL(sysdll_.Add("ws2_32.dll"))
	moddnsapi   = syscall.NewLazyDLL(sysdll_.Add("dnsapi.dll"))
	modiphlpapi = syscall.NewLazyDLL(sysdll_.Add("iphlpapi.dll"))
	modsecur32  = syscall.NewLazyDLL(sysdll_.Add("secur32.dll"))
	modnetapi32 = syscall.NewLazyDLL(sysdll_.Add("netapi32.dll"))
	moduserenv  = syscall.NewLazyDLL(sysdll_.Add("userenv.dll"))
...
func LoadLibrary(libname string) (handle syscall.Handle, err error) {
	var _p0 *uint16
...
func _LoadLibrary(libname *uint16) (handle syscall.Handle, err error) {
...
func FreeLibrary(handle syscall.Handle) (err error) {
...
func GetProcAddress(module syscall.Handle, procname string) (proc uintptr, err error) {
	var _p0 *byte
...
func _GetProcAddress(module syscall.Handle, procname *byte) (proc uintptr, err error) {
...
func CreateFile(name *uint16, access uint32, mode uint32, sa *syscall.SecurityAttributes, createmode uint32, attrs uint32, templatefile int32) (handle syscall.Handle, err error) {
	...
	if netname.Server == "" {
		...
		r0, _, e1 = syscall.Syscall9(GetProc("_CreateFileW"), 7, uintptr(unsafe.Pointer(name)), uintptr(access), uintptr(mode), uintptr(unsafe.Pointer(sa)), uintptr(createmode), uintptr(attrs), uintptr(templatefile), 0, 0)
	}
	handle = syscall.Handle(r0)
...
// // func (handle Handle) ReadFile_(buf []byte, done *uint32, overlapped *syscall.Overlapped) (err error) {
// // 	return ReadFile(handle, buf, done, overlapped)
// // }

func ReadFile_(host string, handle syscall.Handle, buf []byte, done *uint32, overlapped *syscall.Overlapped) (err error) {
	...
	r1, _, e1 := syscall.Syscall6(GetProc("_ReadFile"), 6, uintptr(unsafe.Pointer(serverp)), uintptr(handle), uintptr(unsafe.Pointer(_p0)), uintptr(len(buf)), uintptr(unsafe.Pointer(done)), uintptr(unsafe.Pointer(overlapped)))
	if r1 == 0 {
		if e1 != 0 {
			err = errnoErr(e1)
		} else {
...
// func SetFilePointer(handle syscall.Handle, lowoffset int32, highoffsetptr *int32, whence uint32) (newlowoffset uint32, err error) {
...
func CloseHandle_(host string, fd syscall.Handle) (err error) {
	var serverp *uint16
	serverp, err = syscall.UTF16PtrFromString(host)
	if err != nil {
		return
	}
	r1, _, e1 := syscall.Syscall(GetProc("_CloseHandle"), 2, uintptr(unsafe.Pointer(serverp)), uintptr(fd), 0)
	if r1 == 0 {
		if e1 != 0 {
...
func findFirstFile1(name *uint16, data *win32finddata1) (handle syscall.Handle, err error) {
	...
	// } else {
	// }
	r0, _, e1 = syscall.Syscall(GetProc("_FindFirstFileW"), 2, uintptr(unsafe.Pointer(name)), uintptr(unsafe.Pointer(data)), 0)
	handle = syscall.Handle(r0)
	if handle == syscall.InvalidHandle {
		if e1 != 0 {
			err = errnoErr(e1)
...
func findFirstFile_close1(name *uint16, data *win32finddata1) (err error) {
	...
	if netname.Server == "" {
		...
		r0, _, e1 = syscall.Syscall(GetProc("_FindFirstFileW_Close"), 2, uintptr(unsafe.Pointer(name)), uintptr(unsafe.Pointer(data)), 0)
		if r0 == 0 {
			if e1 != 0 {
				err = errnoErr(e1)
			} else {
...
// func findNextFile1(handle syscall.Handle, data *win32finddata1) (err error) {
...
func findNextFile1_(host string, handle syscall.Handle, data *win32finddata1) (err error) {
	...
	r1, _, e1 := syscall.Syscall(GetProc("_FindNextFileW"), 3, uintptr(unsafe.Pointer(serverp)), uintptr(handle), uintptr(unsafe.Pointer(data)))
	if r1 == 0 {
		if e1 != 0 {
			err = errnoErr(e1)
		} else {
...
func FindClose_(host string, fd syscall.Handle) (err error) {
	var serverp *uint16
	serverp, err = syscall.UTF16PtrFromString(host)
	if err != nil {
		return
	}
	r1, _, e1 := syscall.Syscall(GetProc("_FindClose"), 2, uintptr(unsafe.Pointer(serverp)), uintptr(fd), 0)
	if r1 == 0 {
		if e1 != 0 {
			err = syscall.Errno(e1)
		} else {
...
// func SetEndOfFile(handle syscall.Handle) (err error) {
...
// func GetSystemTimeAsFileTime(time *syscall.Filetime) {
// 	Syscall(procGetSystemTimeAsFileTime.Addr(), 1, uintptr(unsafe.Pointer(time)), 0, 0)
// 	return
// }

// func GetTimeZoneInformation(tzi *syscall.Timezoneinformation) (rc uint32, err error) {
...
// func CreateIoCompletionPort(filehandle syscall.Handle, cphandle syscall.Handle, key uint32, threadcnt uint32) (handle syscall.Handle, err error) {
...
// func GetQueuedCompletionStatus(cphandle syscall.Handle, qty *uint32, key *uint32, overlapped **syscall.Overlapped, timeout uint32) (err error) {
...
// func PostQueuedCompletionStatus(cphandle syscall.Handle, qty uint32, key uint32, overlapped *syscall.Overlapped) (err error) {
...
// func CancelIo(s syscall.Handle) (err error) {
...
func CancelIoEx_(host string, s syscall.Handle, o *syscall.Overlapped) (err error) {
	serverp, err := syscall.UTF16PtrFromString(host)
	if err != nil {
		return 
	}
	r1, _, e1 := syscall.Syscall(GetProc("_CancelIoEx"), 3, uintptr(unsafe.Pointer(serverp)), uintptr(s), uintptr(unsafe.Pointer(o)))
	if r1 == 0 {
		if e1 != 0 {
			err = errnoErr(e1)
		} else {
...
// func CreateProcess(appName *uint16, commandLine *uint16, procSecurity *SecurityAttributes, threadSecurity *SecurityAttributes, inheritHandles bool, creationFlags uint32, env *uint16, currentDir *uint16, startupInfo *syscall.StartupInfo, outProcInfo *syscall.ProcessInformation) (err error) {
// 	var _p0 uint32
// 	if inheritHandles {
// 		_p0 = 1
// 	} else {
...
// func CreateProcessAsUser(token syscall.Token, appName *uint16, commandLine *uint16, procSecurity *SecurityAttributes, threadSecurity *SecurityAttributes, inheritHandles bool, creationFlags uint32, env *uint16, currentDir *uint16, startupInfo *syscall.StartupInfo, outProcInfo *syscall.ProcessInformation) (err error) {
// 	var _p0 uint32
// 	if inheritHandles {
// 		_p0 = 1
// 	} else {
...
// func GetExitCodeProcess(handle syscall.Handle, exitcode *uint32) (err error) {
...
// func GetStartupInfo(startupInfo *syscall.StartupInfo) (err error) {
...
// func GetCurrentProcess() (pseudoHandle syscall.Handle, err error) {
...
// func DuplicateHandle(hSourceProcessHandle syscall.Handle, hSourceHandle syscall.Handle, hTargetProcessHandle syscall.Handle, lpTargetHandle *syscall.Handle, dwDesiredAccess uint32, bInheritHandle bool, dwOptions uint32) (err error) {
// 	var _p0 uint32
// 	if bInheritHandle {
// 		_p0 = 1
// 	} else {
...
// func CreatePipe(readhandle *syscall.Handle, writehandle *syscall.Handle, sa *SecurityAttributes, size uint32) (err error) {
...
func GetFileType_(host string, fd syscall.Handle) (n uint32, err error) {
	serverp, err := syscall.UTF16PtrFromString(host)
	if err != nil {
		return syscall.FILE_TYPE_UNKNOWN, err
	}
	r0, _, e1 := syscall.Syscall(GetProc("_GetFileType"), 2, uintptr(unsafe.Pointer(serverp)), uintptr(fd), 0)
	n = uint32(r0)
	if n == 0 {
		if e1 != 0 {
			err = syscall.Errno(e1)
...
// func SetFileTime(handle syscall.Handle, ctime *syscall.Filetime, atime *syscall.Filetime, wtime *syscall.Filetime) (err error) {
...
//	} else {
		r1, _, e1 = syscall.Syscall(GetProc("_GetFileAttributesEx"), 3, uintptr(unsafe.Pointer(name)), uintptr(level), uintptr(unsafe.Pointer(info)))
//	}
	if r1 == 0 {
		if e1 != 0 {
			err = errnoErr(e1)
...
// func LocalFree(hmem syscall.Handle) (handle syscall.Handle, err error) {
...
// func SetHandleInformation(handle syscall.Handle, mask uint32, flags uint32) (err error) {
...
// func CreateFileMapping(fhandle syscall.Handle, sa *SecurityAttributes, prot uint32, maxSizeHigh uint32, maxSizeLow uint32, name *uint16) (handle syscall.Handle, err error) {
...
// func MapViewOfFile(handle syscall.Handle, access uint32, offsetHigh uint32, offsetLow uint32, length uintptr) (addr uintptr, err error) {
...
// func TransmitFile(s syscall.Handle, handle syscall.Handle, bytesToWrite uint32, bytsPerSend uint32, overlapped *syscall.Overlapped, transmitFileBuf *syscall.TransmitFileBuffers, flags uint32) (err error) {
...
// func TransmitFile_(host string, s syscall.Handle, handle syscall.Handle, bytesToWrite uint32, bytsPerSend uint32, overlapped *syscall.Overlapped, transmitFileBuf *syscall.TransmitFileBuffers, flags uint32) (err error) {
